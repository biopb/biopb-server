...
class TestUcellSmoke(ServiceTestBase):
    """Smoke tests for Ucell service."""

    service_fixture_name = "ucell_service"


class TestUcellIntegration:
    """Integration tests for Ucell-specific features."""

    @pytest.mark.integration
    def test_2d_detection(self, request, test_image_2d):
        """2D cell segmentation should work."""
        service = request.getfixturevalue("ucell_service")
